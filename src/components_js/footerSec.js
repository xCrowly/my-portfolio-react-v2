            ...
            <ul className="footer-item flex-colomn">
                <li>
                    <a href="https://github.com/xCrowly" target={"_blank"}
                        ...
                        rel="noreferrer">
                        <h1>
                            <i><svg className="fa-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                                <path fill="#FFF5EE" d="M165.9 397.4c0 2-2.3 3.6-5.2 3.6-3.3.3-5.6-1.3-5.6-3.6 0-2
                ...
                <li>
                    <a href="https://www.linkedin.com/in/ahmed-badawy-61bb7a213/" target={"_blank"}
                      ...
                      text-decoration-none" rel="noreferrer">
                        <h1>
                            <i><svg className="fa-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
